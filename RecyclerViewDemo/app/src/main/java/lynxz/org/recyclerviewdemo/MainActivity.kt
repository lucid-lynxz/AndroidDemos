...
class MainActivity : BaseActivity() {
    ...
    private fun touchAnimation(view: View, direction: Int) {
        val animatorUp = ObjectAnimator.ofFloat(view, "translationZ", 1f, 10f)
        val animatorDown = ObjectAnimator.ofFloat(view, "translationZ", 10f, 1f)
        val animator = if (direction == 0) animatorUp else animatorDown
